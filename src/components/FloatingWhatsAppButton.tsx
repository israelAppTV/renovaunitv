...
export function resolveWhatsappHref(): string {
  ...
  const message =
    "Olá! Vim pelo site oficial e gostaria de saber mais sobre os códigos de recarga mensal e anual, valores e prazo de liberação.";
...
export function FloatingWhatsAppButton() {
  ...
  return (
    <a
      ...
      aria-label="Falar no WhatsApp sobre recarga"
      className="fixed bottom-5 right-5 z-50 flex h-20 w-20 items-center justify-center rounded-full bg-[#25D366] text-white shadow-2xl transition hover:scale-105 hover:brightness-110 sm:h-24 sm:w-24"
    >
